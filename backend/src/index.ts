...
import positionCandidateRoutes from './routes/positionCandidateRoutes';
...
// Import and use positionCandidateRoutes
app.use('/positions', positionCandidateRoutes);

// Import and use candidateStageRoutes
